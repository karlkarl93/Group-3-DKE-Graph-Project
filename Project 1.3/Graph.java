...
public class Graph {
	...
	*/
	...
	/** Resets the colors of all vertices to the default, Vertex.DEFAULT_BLANK_COLOR
		coloredVertices is set to a new array of size 0
		blankVertices is set to a new array of size n
	*/
	protected void resetColouring() {
	...
	/** Colors the graph using LDO and colorRLFOrRandom()
     */
