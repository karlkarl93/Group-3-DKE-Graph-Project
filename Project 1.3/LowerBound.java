...
public class LowerBound {
	...
	/** Prints the new found lowerBound to the console in the format given by Steven
			and return it
	
		@param int lowerBound, the new best lower bound
		
		@return int lowerBound, the new best lower bound
	*/
	public static int newLowerBound (int lowerBound) {
