public class TestVertexColorOptionsHint {
    /**
    ...
    public static void main(String[] args) {
        ...
        graph.setColor(graph.vertices[3],2);
        graph.setColor(graph.vertices[4],3);
        System.out.println("Colors in graph:");
        printInts(graph.colors);
        
        // Request to find the vertex with fewest color options
        Vertex[] topVertices = graph.findVerticesWithFewestColorOptions(graph.blankVertices);
        
        // Print the result
        System.out.println("These are the vertices with fewest color options");
        printVertices(topVertices);
    }
    ...
    public static void printVertices(Vertex[] array) {
        for (int i = 0; i < array.length; i++) {
            System.out.println("Color Options for vertex: " + i);
            for (int j = 0; j < array[i].colorOptions.length; j++) {
                System.out.println(array[i].colorOptions[j] + " ");
            }
            System.out.println();
        }
        System.out.println();
